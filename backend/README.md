...
## Project Structure
    ...
    ├── test_app_accounting_38092  # Django project configurations
...
1. Clone this repo and `cd test_app_accounting_38092`
...
2. Clone this repo and `cd test_app_accounting_38092`
